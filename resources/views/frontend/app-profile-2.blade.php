...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/app-profile-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2023 09:52:52 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="card card-profile">
							<div class="admin-user">
								<div class="img-wrraper">                              
									<div class="">
										<img src="images/user1.jpg" class="rounded-circle"></div>
												...
												<div id="collapseOne6" class="accordion-collapse collapse show" aria-labelledby="headingOne6" data-bs-parent="#accordionExample6">
													<div class="accordion-body">
														<div class="friend-list">
															<img src="images/profile/friends/f3.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/pic2.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/pic3.jpg" class="avatar avatar-md" alt="">
															<img src="images/profile/friends/f2.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/pic1.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/d4.jpg" class="avatar avatar-md" alt="">
															<img src="images/profile/friends/f4.jpg" class="avatar avatar-md" alt="">
															<img src="images/profile/friends/f1.jpg" class="avatar avatar-md" alt="">
															<img src="images/profile/friends/f3.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/pic2.jpg" class="avatar avatar-md" alt="">
															<img src="images/contacts/pic3.jpg" class="avatar avatar-md" alt="">
															<img src="images/profile/friends/f2.jpg" class="avatar avatar-md" alt="">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0">
										<div class="products">
											<img src="images/profile/friends/f2.jpg" class="avatar avatar-md rounded-circle" alt="">
											<div>
												<h5 class="mb-0"><a href="javascript:void(0)" class="text-black">Thomas Fleming</a></h5>
												<span>8 Hours ago</span>	
											</div>	
