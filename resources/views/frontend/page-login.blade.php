...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2023 09:52:39 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			{{-- <!-- Coming Soon -->                                             ({{url('images/php_mysql.jpg')}}) --}}
			<div class="bg-img-fix overflow-hidden" style="background:#fff ({{url('frontend/images/background/bg6.jpg')}}); height: 100vh;">
				<div class="row gx-0">
								...
								<div class="login-form style-2">
									...
									<div class="card-body">
										<div class="logo-header">
											<a href="{{url('index')}}" class="logo"><img src="{{url('frontend/images/logo/logo-full.png')}}" alt="" class="width-230 light-logo"></a>
											<a href="{{url('index')}}" class="logo"><img src="{{url('frontend/images/logo/logofull-white.png')}}" alt="" class="width-230 dark-logo"></a>
										</div>
										...
										<div class="tab-content w-100" id="nav-tabContent">
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form method="post" action="{{'login-user'}}" class=" dz-form pb-3">
												@csrf
										  ...
										  <div class="tab-pane fade" id="nav-sign" role="tabpanel" aria-labelledby="nav-sign-tab">
											<form class="dz-form py-2" method="post" action="{{route('register-user')}}">
											@csrf	
										...
										<div class="card-footer">
											...
											<div class="col-lg-12 text-center">
												...
												<a href="javascript:void(0);">Finnovity </a> All rights reserved.</span> 
											</div>
										</div>
									</div>	
